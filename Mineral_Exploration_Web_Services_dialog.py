...
"""
/***************************************************************************
 Mineral_Exploration_Web_ServicesDialog
                                 A QGIS plugin
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Mineral_Exploration_Web_Services_dialog_base.ui'))


class Mineral_Exploration_Web_ServicesDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(Mineral_Exploration_Web_ServicesDialog, self).__init__(parent)
